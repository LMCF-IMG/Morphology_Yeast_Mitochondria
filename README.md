...
Two images are **inputs** to the analysis: 1. fluorescence image of mitochondria, **Fig. 1**; 2. DIC image of corresponding yeast cells of the same field of view, **Fig. 6**. DIC images are used to relate selected mitochondrial parameters to individual cells.
...
**Model pro segmentaci, popis vytvoření a odkaz...**
